...
<html>
    ...
    <form action='recovery.php' method = "post">
      ...
      <input id = "password" name = "password" type="password" placeholder="Новый пароль" value="<?= $_POST['password']?>">
      <input id = "passwordNew" name = "passwordNew" type="password" placeholder="Введите новый пароль ещё раз" value="<?= $_POST['passwordNew']?>" >
